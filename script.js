const storageKey = "greenhouse-management-v1";
  ...
  dailyLogs: [
    {
      ...
      owner: "溫室管理員",
      status: "觀察中",
      note: "上午檢查棚內溫濕度、土壤濕度與風扇運轉，南側風扇需要再確認轉速。"
    },
    {
      date: "2026-04-24",
      type: "灌溉",
  ...
  systemLogs: [
    {
      ...
      level: "警告",
      message: "南側循環風扇回報轉速低於設定值，已加入維修清單。"
    },
    {
      time: "2026-04-25T07:40",
      level: "資訊",
      message: "資料同步完成，已匯入 0423 至 0424 感測器數值。"
    },
    {
      time: "2026-04-24T16:30",
      level: "注意",
      message: "棚內濕度高於 70%，通風策略改為每 20 分鐘啟動。"
    }
  ],
  tasks: [
    { id: 1, text: "檢查南側風扇轉速", done: false },
    { id: 2, text: "補登 0424 採收重量", done: false },
    { id: 3, text: "確認土壤感測器校正值", done: true }
  ],
  progress: [
    { name: "環境資料自動彙整", value: 82 },
    { name: "風扇降溫測試分析", value: 68 },
    { name: "每日管理流程數位化", value: 45 },
    { name: "異常告警通知設定", value: 56 }
  ],
  calendarEvents: {
    8: ["0408 溫室資料分析"],
    17: ["0417 棚內溫濕度測試"],
